...
export default function PortfolioGrid() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {!isReady && (
          ...
          >
            ...
            >
              <h2 className="text-4xl md:text-6xl font-['Great_Vibes'] text-[#8B6F47] mb-6">
                Portfolio
              </h2>
      ...
      {/* 2. MAIN CONTENT (Hidden until ready) */}
      <main className={`bg-gradient-to-b from-[#f3ca8c] via-[#ecd0a5] to-[#f0e1d7] min-h-screen transition-all duration-1000 ${isReady ? 'opacity-100 blur-0' : 'opacity-0 blur-md'}`}>
        <div className="max-w-[1600px] mx-auto pt-20 px-2 md:px-4">
                ...
                >
                  <div className="relative w-full h-auto overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                       <p className="text-white text-[10px] uppercase tracking-widest font-bold">View Story</p>
                    </div>
                  </div>
                </motion.div>
              );
      ...
      <AnimatePresence>
        {selectedMedia && (
            // ... your existing Lightbox code here ...
            <div /> 
        )}
      </AnimatePresence>
    </>
